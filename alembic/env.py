...
# because my db password contains %, thats why follwoing three lines are required.
...
# escape % so configparser does not interpret them
url_escaped = url.replace('%', '%%')

config.set_main_option("sqlalchemy.url", url_escaped)


# config.set_main_option( # this way will work if password does not contain %
